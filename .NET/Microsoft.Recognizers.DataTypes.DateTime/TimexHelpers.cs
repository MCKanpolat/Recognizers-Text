...
namespace Microsoft.Recognizers.DataTypes.DateTime
{
    public static class TimexHelpers
    {
        ...
        public static Tuple<System.DateTime, System.DateTime> DateRangeFromTimex(Timex timex)
        {
            var expanded = ExpandDateTimeRange(timex);
            return Tuple.Create(DateFromTimex(expanded.Start), DateFromTimex(expanded.End));
        }

        public static Tuple<Time, Time> TimeRangeFromTimex(Timex timex)
        {
            var expanded = ExpandTimeRange(timex);
            return Tuple.Create(TimeFromTimex(expanded.Start), TimeFromTimex(expanded.End));
        }
