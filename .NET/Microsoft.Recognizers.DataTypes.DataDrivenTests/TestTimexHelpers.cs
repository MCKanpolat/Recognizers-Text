...
namespace Microsoft.Recognizers.DataTypes.DateTime.Tests
{
    ...
    public class TestTimexHelpers
    {
        ...
        public void Helpers_DateRangeFromTimex()
        {
            ...
            Assert.AreEqual(new System.DateTime(2017, 9, 27), range.Item1);
            Assert.AreEqual(new System.DateTime(2017, 9, 29), range.Item2);
        }
        ...
        public void Helpers_TimeRangeFromTimex()
        {
            ...
            Assert.AreEqual(new Time(14, 0, 0).GetTime(), range.Item1.GetTime());
            Assert.AreEqual(new Time(16, 0, 0).GetTime(), range.Item2.GetTime());
        }
